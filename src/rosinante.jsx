...
class Rosinante {
    ...
    constructor({scrollContainer, scrollItem, scrollTarget, once, visible, notVisible, throttle, responsiveBreakPoint, elementPieceSmall, elementPieceLarge}) {
    ...
    callRosinante() {
      ...
      if (this.Rosinante.scrollContainer) {
    ...
    rosinanteHeart() {
      ...
      if (this.Rosinante.scrollTarget) {
