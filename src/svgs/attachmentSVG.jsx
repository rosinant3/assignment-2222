...
const AttachmentSVG = () => {
    ...
    return (<svg className="svg-super-small svg-margin-right" version="1.1" id="attachment" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
