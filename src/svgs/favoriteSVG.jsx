...
const FavoriteSVG = () => {
    ...
    return (<svg className="svg-size svg-margin-right svg-pointer" version="1.1" id="favorite" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    viewBox="0 0 32 32" style={{ enableBackground: "new 0 0 32 32" }} xmlSpace="preserve">
<g>
   <path fill="lightgrey" d="M22.1,6c1.509,0,2.934,0.579,4.008,1.628c1.059,1.038,1.642,2.416,1.642,3.882c0,1.465-0.583,2.844-1.64,3.879
